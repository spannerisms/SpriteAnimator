...
public abstract class Database {
	...
	public static final String[] ALLFRAMES = {
			...
			// standUp
			"[standUp]A2{0,0}{F}{0}:C1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} ",
			// standDown
			"[standDown]A1{0,0}{F}{0}:B3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} ",
			...
			"[bonk]F3{0,-3}{F}{0}:G3{0,16}{T}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// bonkUp TODO: 100% confirm ; F4
			"[bonkUp]F4{0,-3}{F}{0}:G4{0,16}{T}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// bonkDown TODO: 100% confirm ; F2
			"[bonkDown]F2{0,-3}{F}{0}:G2{0,16}{T}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			...
			"[swimUp]A2{0,-3}{F}{0}:I5{0,8}{F}{0} @ 3 ;" +
				"E4{0,-3}{F}{0}:I6{0,8}{F}{0} @ 3 ",
			...
			"[attack]A0{0,-3}{F}{0}:C2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:C3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:C4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:α7{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"Z6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:C4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:C5{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// attackUp TODO: 100% confirm ; F1,A2:D1,A2:D2,A2:β1,A2:D2,A2:L4
			"[attackUp]F1{0,-3}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:D1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:D2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:β1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:D2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:L4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// attackDown TODO: 100% confirm ; F0,A1:C6,A4:D0,A4:β0,A4:D0,A3:L3
			"[attackDown]F0{0,-3}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:C6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,-3}{F}{0}:D0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,-3}{F}{0}:β0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,-3}{F}{0}:D0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A3{0,-3}{F}{0}:L3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// dashRelease TODO: 100% confirm ; A0:M6,K3:V1,A0:M6,K4:M7
			"[dashRelease]A0{0,-3}{F}{0}:M6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"K3{0,1}{F}{0}:V1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:M6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"K4{0,2}{F}{0}:M7{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// dashReleaseUp TODO: 100% confirm ; A2:M3,A2:M4,A2:M5,A2:M3,A2:M4-M,A2:M5-M,A2:M3-M
			"[dashReleaseUp]A2{0,-3}{F}{0}:M3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M5{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M4{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M5{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M3{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ",
			// dashReleaseDown TODO: 100% confirm ; A1:M0,A1:M1,A1:M2,A1:M0,A1:β2,A1:β3,A1:M0
			"[dashReleaseDown]A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:M1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:M2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:β2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:β3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			...
			"[salute]A3{0,-3}{F}{0}:P4{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ",
			// itemGet TODO: 100% confirm ; L1:L2
			"[itemGet]L1{0,-3}{F}{0}:L2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// triforceGet TODO: 100% confirm ; Z2:β4
			"[triforceGet]Z2{0,-3}{F}{0}:β4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			...
			"[lift]E2{0,-3}{F}{0}:U5{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"U1{0,-3}{F}{0}:U6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"L6{0,-3}{F}{0}:O2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			...
			"[bombos]A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{M}:M6{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-3}{F}{0}:M3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{0}:M6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{0,-3}{F}{M}:M6{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ;" +
			...
			"[quake]A1{0,-3}{F}{0}:M0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				...
				"A1{0,-3}{F}{0}:P4{0,8}{F}{M}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"L5{0,-3}{F}{0}:N7{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,-3}{F}{0}:Q1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
