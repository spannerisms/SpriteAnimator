...
public abstract class Database {
	...
	public static final String[] ALLFRAMES = {
			...
			"[attack]A0{-1,1}{F}{0}:C2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{-1,1}{F}{0}:C3{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A0{1,1}{F}{0}:C4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
			...
			"[attackUp]F1{0,0}{F}{0}:G1{0,16}{T}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-1}{F}{0}:D1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-2}{F}{0}:D2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-5}{F}{0}:β1{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,-2}{F}{0}:D2{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A2{0,0}{F}{0}:L4{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ",
			// attackDown TODO: 100% confirm ; F0,A1:C6,A4:D0,A4:β0,A4:D0,A3:L3
			"[attackDown]F0{0,0}{F}{0}:G0{0,16}{T}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A1{0,1}{F}{0}:C6{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,2}{F}{0}:D0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,5}{F}{0}:β0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
				"A4{0,2}{F}{0}:D0{0,8}{F}{0}:SHADOW0{0,8}{F}{0} @ 3 ;" +
